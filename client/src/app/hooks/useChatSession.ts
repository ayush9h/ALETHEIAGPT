 ...
 * Currently supports:
 * - Deleting a session
 * - Resetting selected session if deleted
 * - Clearing messages when active session is removed
 *
...
export function useChatSession(authuserId:string | undefined, dispatch: Dispatch<ChatAction>, selectedSessionId:number | null){
    /**
